/*
  ==============================================================================
    Control Panel - MIDI-controlled unified parameter controls for both plugins
  ==============================================================================
*/
...
public:
    ...
    // Slider listener for MIDI CC mapping
    void sliderValueChanged(juce::Slider* slider) override;
    
    // Callback for when parameter changes via MIDI
...
private:
    struct ParameterControl
    {
        ...
        int midiCC;  // MIDI CC number (0-119)
        float currentValue{0.5f};  // Default to 0.5
    };
